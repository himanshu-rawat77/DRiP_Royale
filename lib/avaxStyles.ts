/**
 * AvaxGods-style class names (from project_web3_battle_game)
 */
export const styles = {
  headText:
    "font-rajdhani font-bold text-white sm:text-6xl text-4xl",
  ...
  battlegroundContainer: "bg-landing flex-col py-8 sm:py-12 px-4",
  ...
  gameContainer:
    "bg-cover bg-no-repeat bg-center flex-col",
